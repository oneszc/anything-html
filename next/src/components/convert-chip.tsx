...
/**
 * Single Convert entry point in the toolbar. It also owns the ⌘/Ctrl+Enter
 * shortcut so the trigger logic stays in one place.
 */
export function ConvertChip() {
  ...
  return (
    <button
      ...
      className="group relative flex items-center gap-2 rounded-full px-4 py-2.5 text-[12.5px] font-medium shadow-lg transition-all hover:scale-[1.02] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-40"
      style={{
